<x-layout>
    <x-slot name="main">
        ...
        <div class="min-h-screen bg-gray-100 flex items-center justify-center p-6">
            ...
            <div class="w-full max-w-3xl bg-white rounded-2xl shadow-lg p-8">f
                ...
                <form action="{{url('/mcqs/update/'.$mcq->id)}}" method="post" class="space-y-5">
                    ...
                    <div id="optionsContainer" data-count="{{$mcq->options->count()}}" class="space-y-4">
        ...
        <script>
            ...
            let optionCount =
                Number(optionsContainer.dataset.count);
