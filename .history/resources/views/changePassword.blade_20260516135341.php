        ...
        <div class="flex flex-col items-center justify-center min-h-screen p-4">
            <div class=" w-full max-w-md bg-white flex flex-col items-center p-8 rounded-2xl shadow-lg">
                ...
                <form action="{{url('/login')}}" method="post" class="space-y-4 w-full m-4">
                    @csrf
                    <input type="password" name="currpass" placeholder="Enter Cur" class="w-full border border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 px-4 py-2 rounded-xl"><br>
