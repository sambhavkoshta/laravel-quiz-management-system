    ...
    <x-slot name="main">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Quiz Results</h1>
                    <p class="mt-2 text-sm text-gray-500">A comprehensive list of student scores and performance metrics.</p>
                </div>
            </div>
