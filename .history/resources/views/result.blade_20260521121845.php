        ...
        <div class="min-h-screen bg-gray-100 flex items-center justify-center p-6">
            <div class="w-full max-w-2xl bg-white rounded-3xl shadow-xl overflow-hidden">
                ...
                <div class="p-8 text-center space-y-6">
                    ...
                    @endif
                    <a href="{{url('/student/categories')}}" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-2xl text-lg hover:bg-blue-700 transition">
                        Back to Categories
                    </a>
                </div>
                <div>
