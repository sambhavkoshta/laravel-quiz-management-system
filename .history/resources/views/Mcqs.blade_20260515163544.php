...
<form action="{{url('/mcqs/add')}}" method="post">
    ...
    <input type="text" name="question" placeholder="Option A"><br>
    <input type="text" name="question" placeholder="Option B"><br>
    <input type="text" name="question" placeholder="Option C"><br>
    <input type="text" name="question" placeholder="Option D"><br>
