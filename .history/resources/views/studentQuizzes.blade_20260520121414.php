    ...
    <x-slot name="main">
        ...
        <div class="min-h-screen bg-white m-4 rounded-xl overflow-hidden">
            ...
            <div class="flex justify-center m-4">
                <a href="{{url('/student/history')}}" class="bg-green-500 px-4 py-2 text-white rounded-2xl text-xl shadow">Quiz History</a>
            </div>
        </div>
        @else
        <div class="bg-yellow-100 text-yellow-700 p-4 rounded-xl text-2xl m-4">
