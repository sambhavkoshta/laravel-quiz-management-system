<nav class="w-full bg-white shadow">
    <div class="flex items-center justify-between px-4 py-2">
        ...
        <ul class="absolute left-0 right-0 top-full mt-2 bg-gray-800 p-4 space-y-3 rounded-lg shadow-xl hidden md:static md:mt-0 md:p-0 md:flex md:space-y-0 md:space-x-6 md:block" id="menu-items">
            @if(session('student'))
