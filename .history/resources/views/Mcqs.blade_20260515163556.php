...
<form action="{{url('/mcqs/add')}}" method="post">
    ...
    <input type="text" name="option_a" placeholder="Option B"><br>
    <input type="text" name="option_a" placeholder="Option C"><br>
    <input type="text" name="option_a" placeholder="Option D"><br>
