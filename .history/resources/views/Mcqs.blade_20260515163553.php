...
<form action="{{url('/mcqs/add')}}" method="post">
    ...
    <input type="text" name="option_" placeholder="Option A"><br>
    <input type="text" name="option_" placeholder="Option B"><br>
    <input type="text" name="option_" placeholder="Option C"><br>
    <input type="text" name="option_" placeholder="Option D"><br>
