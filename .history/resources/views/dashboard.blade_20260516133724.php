<x-layout>
    <x-slot name="main">
        ...
        <div class="p-4 m-4 flex flex-col items-center text-left justify-center bg-white  rounded-2xl">
            <div class="text-3xl font-bold text-gray-700 bg-blue-500">
                <h1 class="w-full bg-blue-500">Student dashboard</h1>
            </div>
