<x-layout>
    <x-slot name="main">
        <div class="bg-white rounded-2xl m-4 px-4 sm:px-6 lg:px-8 py-8">
            
            <div class="sm:flex sm:items-center sm:justify-between mb-8 bg-blue-500 px-6 py-2 rounded-full">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-white sm:text-3xl ">Quiz Results</h1>
                </div>
            </div>
