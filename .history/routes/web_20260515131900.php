...
Route::get('/quizzes', [CategoryController::class, 'showCategory'])->middleware('admin.auth');
Route::post('/quizzes/add', [CategoryController::class, 'addCategory'])->middleware('admin.auth');

Route::get('/quizzes/edit/{id}', [CategoryController::class, 'showEdit'])->middleware('admin.auth');
Route::post('/quizzes/update/{id}', [CategoryController::class, 'updateCategory'])->middleware('admin.auth');

Route::get('/quizzes/delete/{id}', [CategoryController::class, 'deleteCategory'])->middleware('admin.auth');
