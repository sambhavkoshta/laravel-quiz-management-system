...
Route::get('/student/categories', [StudentQuizController::class, 'showCategories'])->middleware('check.session');
Route::get('/student/quizzes/{id}', [StudentQuizController::class, 'showQuizzes'])->middleware('check.session');
Route::get('quiz/start/{id}',[StudentQuizController::class,'startQuiz'])->middleware('check.session');
Route::post('quiz/submit/{id}',[StudentQuizController::class, 'submitQuiz'])->middleware('check.session');
Route::get('/student/history',[StudentQuizController::class, 'history'])->middleware('check.session');
Route::get('/student/leaderBoard/{id}',[StudentQuizController::class,'leaderBoard'])->middleware('check.session');