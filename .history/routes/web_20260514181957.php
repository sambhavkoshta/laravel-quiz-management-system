...
Route::get('/edit/{id}',[StudentController::class,'showEdit']);
...
Route::get('/change-password',[StudentController::class,'showChangePassword']);
Route::get('/change-password',[StudentController::class,'sChangePassword']);