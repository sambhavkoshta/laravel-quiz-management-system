...
// admin
Route::get('/admin-login',[Admin::class,'showAdminLogin']);
Route::post('/admin-login',[StudentController::class, 'adminLogin']);

Route::get('/admin-register',[StudentController::class,'showAdminRegister']);
Route::post('/admin-register',[StudentController::class,'adminRegister']);
