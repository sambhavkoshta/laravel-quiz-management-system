...
Route::get('/quizzes', [McqController::class, 'showQuiz'])->middleware('admin.auth');
Route::post('/quizzes/add', [McqController::class, 'addQuiz'])->middleware('admin.auth');

Route::get('/quizzes/edit/{id}', [McqController::class, 'showEdit'])->middleware('admin.auth');
Route::post('/quizzes/update/{id}', [McqController::class, 'updateQuiz'])->middleware('admin.auth');

Route::get('/quizzes/delete/{id}', [McqController::class, 'deleteQuiz'])->middleware('admin.auth');