...
class McqController extends Controller
{
    ...
    function updateMCQ(Request $request, $id){
        $request->validate([
            ...
            'option_a'=>'required|min:5|unique:mcqs,question,'.$id,
            'option_b'=>'required|min:5|unique:mcqs,question,'.$id,
            'option_c'=>'required|min:5|unique:mcqs,question,'.$id,
            'option_d'=>'required|min:5|unique:mcqs,question,'.$id,
            'correct_answer'=>'required|min:5|unique:mcqs,question,'.$id,
        ])
    }
}
